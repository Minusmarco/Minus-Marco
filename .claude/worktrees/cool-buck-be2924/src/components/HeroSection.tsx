  ...
  return (
    <section className="relative flex flex-col min-h-screen pt-20">
      ...
      <div className="relative flex-1 flex items-end min-h-[75vh] overflow-hidden bg-surface">
        ...
        <div className="absolute bottom-0 left-0 h-[300px] w-[400px] rounded-full bg-gold opacity-[0.04] blur-[120px] pointer-events-none" />

        {/* Logomark watermark */}
        <div className="absolute bottom-0 right-0 w-[480px] h-[480px] opacity-[0.04] pointer-events-none select-none overflow-hidden">
          <Image
        ...
        >
          <motion.span variants={fadeUp} className="inline-block mb-5 rounded-sm bg-gold px-3 py-1 font-display text-xs font-bold uppercase tracking-widest text-bg">
            {FEATURED.category}
          </motion.span>
